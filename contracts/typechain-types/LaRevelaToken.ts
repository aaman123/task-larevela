...
export interface LaRevelaTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface LaRevelaToken extends BaseContract {
  connect(runner?: ContractRunner | null): LaRevelaToken;
  waitForDeployment(): Promise<this>;

  interface: LaRevelaTokenInterface;
